...
(async () => {
  ...
  try {
    ...
    await writeFile('./config.json', JSON.stringify({
      ...
      level: 999,
      status: 'FortniteBalls',
      friendaccept: true,
      inviteaccept: true,
      platform: 'MAC',
  }, null, 2));
    console.log('\x1b[31mWARNING: \x1b[0m');
    return;
  }

  console.log('\x1b[36mLobby Bot made by Scorpyy');

  process.stdout.write('\x1b[33mlol\x1b[0m');
  let cosmetics;
  try {
